...
//							    update-end--Author:chenjin  Date:20160718 for：扩展标签<t:dgCol 增加字段defaultVal=""		
						...
						if(this.DATE_FORMATTER.equals(col.getFormatter())){
							...
							sb.append("<input type=\"text\" name=\""+col.getField()+"_begin1\"  style=\"width: 161px\" "+extendAttribute(col.getExtend())+" class=\"Wdate\" onClick=\"WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})\"/>");
							sb.append("<span style=\"display:-moz-inline-box;display:inline-block;width: 8px;text-align:right;\">~</span>");
							sb.append("<input type=\"text\" name=\""+col.getField()+"_end2\"  style=\"width: 161px\" "+extendAttribute(col.getExtend())+" class=\"Wdate\" onClick=\"WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})\"/>");
							ifNewRow ++;
						}else{
