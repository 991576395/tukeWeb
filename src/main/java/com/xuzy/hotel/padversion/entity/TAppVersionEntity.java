package com.xuzy.hotel.padversion.entity;
...
public class TAppVersionEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="VERSION_CODE",nullable=true,length=32)
