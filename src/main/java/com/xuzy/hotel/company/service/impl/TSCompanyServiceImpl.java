package com.xuzy.hotel.company.service.impl;
...
public class TSCompanyServiceImpl extends CommonServiceImpl implements TSCompanyServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TSCompanyEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(TSCompanyEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(TSCompanyEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(TSCompanyEntity t){
		...
		map.put("company_address", t.getCompanyAddress());
		return map;
	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TSCompanyEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("t_s_company",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
