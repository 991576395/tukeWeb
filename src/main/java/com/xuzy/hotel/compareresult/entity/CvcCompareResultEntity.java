package com.xuzy.hotel.compareresult.entity;
 ...
 */
@Entity
@Table(name = "cvc_compare_result", schema = "")
@SuppressWarnings("serial")
public class CvcCompareResultEntity implements java.io.Serializable {
	/**主键*/
	...
	/**剔税价对比结果*/
	@Excel(name="剔税价对比结果",width=15)
	private java.lang.String tishuijiadbjg;
	/**含税价对比结果*/
	@Excel(name="含税价对比结果",width=15)
	private java.lang.String hanshuijiadbjg;
	/**货期对比结果*/
	@Excel(name="货期对比结果",width=15)
	private java.lang.String huoqidbjg;
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  剔税价对比结果
	 */
	public void setTishuijiadbjg(java.lang.String tishuijiadbjg){
		this.tishuijiadbjg = tishuijiadbjg;
	}
	/**
	 *方法: 取得java.lang.String
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  含税价对比结果
	 */
	public void setHanshuijiadbjg(java.lang.String hanshuijiadbjg){
		this.hanshuijiadbjg = hanshuijiadbjg;
	}
	/**
	 *方法: 取得java.lang.String
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  货期对比结果
	 */
	public void setHuoqidbjg(java.lang.String huoqidbjg){
		this.huoqidbjg = huoqidbjg;
	}
}
