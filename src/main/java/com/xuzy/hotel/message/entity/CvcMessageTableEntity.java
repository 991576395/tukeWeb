package com.xuzy.hotel.message.entity;
 ...
 */
@Entity
@Table(name = "cvc_message_table", schema = "")
@SuppressWarnings("serial")
public class CvcMessageTableEntity implements java.io.Serializable {
	/**主键*/
	...
	private java.lang.Integer ifRead;
	
	/**
	 * 保留字段
	 */
	private String baoLiuValue;
	...
	@Column(name ="IF_READ",nullable=true,length=1)
	public java.lang.Integer getIfRead(){
		return this.ifRead;
	}
	 ...
	 */
	public void setIfRead(java.lang.Integer ifRead){
		this.ifRead = ifRead;
	}
	/**
	 *方法: 取得java.lang.String
	...
	@Column(name ="BAOLIUVALUE",nullable=true,length=20)
	public String getBaoLiuValue() {
		return baoLiuValue;
	}

	public void setBaoLiuValue(String baoLiuValue) {
		this.baoLiuValue = baoLiuValue;
	}
