...
public interface CvcDeliveryOrderDao{
	...
	@Sql("UPDATE cvc_delivery_order SET  signin_date=:signDate,update_time=:updateTime WHERE invoice_no = :invoiceNo")
	int updateSignDate(@Param("signDate") String signDate,@Param("invoiceNo") String invoiceNo,@Param("updateTime") long updateTime);
	 ...
	 */
	 ...
	 @Sql("UPDATE cvc_delivery_order SET signin_date= :signdate,update_time=:updateTime  WHERE order_id= :orderId LIMIT 1")
	 public void updateSigndate(@Param("orderId") int orderId,@Param("signdate") String signdate,@Param("updateTime") long updateTime);
	 
	 @Sql("UPDATE cvc_delivery_order SET invoice_no=:invoiceNo,shipping_id=:shippingId,shipping_name=:shippingName,update_time=:updateTime  WHERE order_id= :orderId LIMIT 1 ")
	 public void updateNu(@Param("orderId") int orderId,@Param("shippingId") int shippingId,@Param("shippingName") String shippingName,@Param("invoiceNo") String invoiceNo,@Param("updateTime") long updateTime);
