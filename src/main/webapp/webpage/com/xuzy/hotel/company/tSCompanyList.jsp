...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tSCompanyList" checkbox="true" pagination="true" fitColumns="true" title="公司维护" actionUrl="tSCompanyController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="公司名称"  field="companyName"  query="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="公司地址"  field="companyAddress"  query="true"  queryMode="single"  width="120"></t:dgCol>
 ...
 <script src = "webpage/com/xuzy/hotel/company/tSCompanyList.js"></script>		
