 ...
 <body>
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						    <input id="goodName" name="goodName" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${cvcInventoryTablePage.goodName}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="companyGoodNumber" name="companyGoodNumber" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${cvcInventoryTablePage.companyGoodNumber}'/>
							<span class="Validform_checktip"></span>
