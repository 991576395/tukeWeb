...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding:0px;border:0px">
	  <t:datagrid name="tOrderList" title="抓单统计" actionUrl="cvcGetOrderStatistics.do?datagrid"  queryMode="group" pageSize="15" idField="id" fit="true">
		   ...
		   <t:dgCol title="异常订单(未处理)" field="exceptionCount" url="cvcOrderInfo.do?list&batchNo=#{unifiedBatchNo}&exceptionStatus=2&isShow=1" funname="toLoadNewTab"   width="80"></t:dgCol>
		   <t:dgCol title="异常订单(已处理)" field="exceptionDoCount" url="cvcOrderInfo.do?list&batchNo=#{unifiedBatchNo}&exceptionStatus=2&isShow=2" funname="toLoadNewTab"   width="80"></t:dgCol>
		   ...
		   <t:dgCol title="退货订单" field="backCount" url="cvcOrderInfo.do?list&batchNo=#{unifiedBatchNo}&orderStatus=7" funname="toLoadNewTab"   width="80"></t:dgCol>
			...
			<t:dgFunOpt title="导出EXCEL"   urlclass="ace_button" urlfont="fa-file-excel-o"  funname="excelOut(unifiedBatchNo)"/>
	  </t:datagrid>
  </div>
