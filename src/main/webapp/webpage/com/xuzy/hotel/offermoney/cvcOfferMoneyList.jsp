...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="cvcOfferMoneyList" checkbox="false" pagination="true" fitColumns="true" title="报价表" actionUrl="cvcOfferMoneyController.do?datagrid" idField="id" fit="true" queryMode="group">
