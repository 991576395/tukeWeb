...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="cvcOfferMoneyList" checkbox="true" pagination="false" fitColumns="false" collapsible="false" title="报价表" actionUrl="cvcOfferMoneyController.do?datagridOther" idField="id" fit="true" queryMode="group">
...
//导入
function ImportXls() {
	openuploadwin('Excel导入', 'cvcOfferMoneyController.do?upload', "cvcOfferMoneyList");
}
...
function ExportXlsByT() {
	JeecgExcelExport("cvcOfferMoneyController.do?exportXlsByT","cvcOfferMoneyList");
}
