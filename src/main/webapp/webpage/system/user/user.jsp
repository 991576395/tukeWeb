...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userController.do?saveUser" beforeSubmit="setOrgIds">
	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" nowrap>
                <input id="companyid" name="companyid" type="hidden" value="${user.company.id}"/>
                <input name="companyName" id="companyName" class="inputxt" value="${user.company.companyName}" readonly="readonly" datatype="*" />
                <t:choose hiddenName="companyid" hiddenid="id" textname="companyName" url="tSCompanyController.do?choiceCompanyList" name="companyList" icon="icon-search" title="公司列表" isclear="true" isInit="true"></t:choose>
            </td>
		</tr>
		<tr>
