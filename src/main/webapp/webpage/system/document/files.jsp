...
<t:formvalid formid="formobj" layout="div" dialog="true" beforeSubmit="upload">
	...
	<div class="form">
		<t:upload name="fiels" buttonText="上传文件" uploader="jeecgFormDemoController.do?saveFiles&documentId=${doc.id}" view="true"  extend="" id="file_upload" formData="documentTitle"></t:upload>
	</div>
